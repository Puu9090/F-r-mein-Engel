...
`Unsere Liebe hatte Geschmack — meistens Döner.`,
...
`Unsere gemeinsamen Tränen....zärtlich gewordene Worte.`,
`Ich liebte, wie ehrlich du warst, auch wenn es schwer fiel...`,
`Frankfurt...deine Strassen tragen unsere Fußabdrücke`,
`Du und ich gegen die Langeweile — jedes Mal gewonnen.`,
`Ich denk an unser erstes gemeinsames Bild.`,
`Dein Kuss war mein Lieblingsmorgenritual.`,
`Wir machten Nächte zu Tagen und Tage zu Geschichten.`,
`...wenn du auf Cityroller vor mir fährst...💜`,
`Döner, Chips, Süßes — hier sind unsere Geheimnisse.`,
`💜... in jeder Sprache, auch ohne Worte.`,
`Du warst die Person, mit der ich alles teilen wollte.`,
`Unsere Stunden sind wie kleine Universen.`,
`Ich erinnere mich an das Salz auf deiner Haut...nach der Sauna`,
`Wir sind perfekt darin, uns gegenseitig aufzurichten.`,
`💜...wie wir zusammen weinen und wieder lachen.`,
`069 — eine kleine Zahl mit riesigem Gewicht.`,
`Du machst eine Stadt zu einem Zuhause.`,
`💜...deine Stimme, wenn du ganz bei mir warst.`,
